...
import { ContainerREgistrados, NavRegistrados, User, Role, Corr, Tel } from './AdminSuscriptores'

const AdminSuscriptores = ({toggleModalHistorial}) => {
    ...
    const filterActive = allWorkers && allWorkers.filter( w => w.subscribed === true)
    ...
    return (
        <ContainerREgistrados>
            ...
            {
                filterActive && filterActive.map( u => (
                    <CardAdminR
                        id={u.userId.uid}
                        ...
                        toggleModalDetailUser={toggleModalHistorial}
                    />
